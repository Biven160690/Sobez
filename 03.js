...
//=========================NEW +THIS===========================
// На практике нам часто надо создавать много объектов одного вида, например пользователей, товары или что-то ещё.Как мы уже знаем из главы Конструкторы, создание объектов через "new", с этим может помочь new function.

// function Cat(color, name) {
//    this.color = color
//     this.name = name
// //}
// const cat = new Cat('Sergey', 'red') // создаеться функция конструктор
// console.log(cat)
